...
public class MockDataGenerator {
    ...
    private static final String categoryNames[] = new String[] {
            "Свежая Рыба", "Замороженная Рыба", "Моллюски", "Копченая Рыба",
            "Консервированная Рыба", "Премиум Рыба", "Местный Улов", "Экзотическая Рыба" };

    private static String[] word1 = new String[] { "Свежий", "Дикий",
            "Премиум", "Органический", "Экологичный", "Морской",
            "Фермерский", "Атлантический", "Тихоокеанский", "Норвежский",
            "Средиземноморский", "Исландский", "Шотландский", "Японский",
            "Аляскинский", "Глубоководный", "Прибрежный", "Импортный",
            "Сезонный", "Гурманский", "Целый" };

    private static String[] word2 = new String[] { "Лосось", "Тунец",
            "Треска", "Палтус", "Форель", "Окунь морской", "Скумбрия",
            "Сардины", "Снэппер", "Дорадо", "Рыба-меч",
            "Пикша", "Тилапия", "Сом", "Сельдь",
            "Камбала", "Анчоусы", "Групер", "Окунь",
            "Осетр", "Судак" };
    ...
    private static Product createProduct(List<Category> categories) {
        ...
        // Set a random product type
        p.setProductType(ProductType.values()[random.nextInt(ProductType.values().length)]);
